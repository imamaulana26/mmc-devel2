					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-3">
									<input type="text" name="rate_bank" value="<?= $row->rate_bank ?>" class="form-control">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="rek_agent" value="<?= $row->rek_agent ?>" class="form-control">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="text" name="no_skkp" value="<?= $row->no_skkp ?>" class="form-control">
								</div>
							</div>
						</div>
					</div>
	                			...
	                			<div class="col-md-5">
			                		<div class="datepicker-center">
										<div class="input-group date">
											...
											<input type="text" name="tgl_komite" class="form-control" placeholder="yyyy-mm-dd" value="<?= $row->tgl_komite ?>">
										</div>
									</div>
			                	</div>
	                		</div>
