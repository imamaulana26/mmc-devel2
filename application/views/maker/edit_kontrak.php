									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="margin" id="margin" class="form-control" placeholder="Ex. 15.00" value="<?= $row->margin ?>">
												</div>
														...
														<div class="input-group" style="margin-bottom: 10px">
															<select name="kode_biaya[]" class="form-control selectpicker">
																...
																<?php $list = array('FINAPP' => 'Biaya Penilalaian', 'FINDIS' => 'Biaya Pencairan Murabahah', 'FININS' => 'Biaya Asuransi', 'FINNTRY' => 'Biaya Notaris', 'FINOTH' => 'Biaya Lain - lain', 'FINSMTP' => 'Biaya Materai');
																		foreach ($list as $key => $li) {
																			$select = '';
																			if ($key == $exp[$i]) $select = 'selected';
																			echo "<option value='" . $key . "' $select>" . $key . " - " . $li . "</option>";
																		} ?>
															</select>
															<div class="input-group-addon btn btn-danger btn-remove">-</div>
														</div>
													<?php } ?>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-5 multiple-form-group-2">
													<?php $exp = explode("::", $row->nom_biaya);
														if ($exp[0]) { ?>
														<div style="margin-bottom: 10px">
															<input type="number" name="nilai_biaya[]" value="<?= $exp[0] ?>" class="form-control">
														</div>
													<?php }
														for ($i = 1; $i < count($exp); $i++) { ?>
														<div class="input-group" style="margin-bottom: 10px">
															<input type="number" name="nilai_biaya[]" value="<?= $exp[$i] ?>" class="form-control">
