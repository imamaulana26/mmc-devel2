		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<?php foreach ($data->result() as $row) { ?>
					<form method="post" id="formValid" action="<?= site_url(ucfirst('maker/induk/simpanData')) ?>" class="form-horizontal" autocomplete="off">
										...
										<div class="col-md-5">
											<select name="sts_nikah" id="sts_nikah" class="form-control selectpicker">
												<?php $arr = array('Single', 'Menikah', 'Cerai');
													foreach ($arr as $arr) {
														$select = '';
														if ($row->sts_nikah == $arr) $select = 'selected';
