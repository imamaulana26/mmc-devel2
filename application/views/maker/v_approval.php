<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Pembiayaan Approve</h3>
                </div>
                <div class="panel-body">
                    <table class="table table-bordered table-hover" id="tbl_approve" style="width: 100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>No. Aplikasi</th>
                        ...
                        <tbody>
                            <?php $no = 1;
                            foreach ($get_approve->result_array() as $row) { ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table style="width: 100%" class="table table-bordered table-hover" id="tbl_revisi">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>No. Aplikasi</th>
                        ...
                        <tbody>
                            <?php $no = 1;
                            foreach ($get_revisi->result_array() as $row) { ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td>
                                        <a href="" data-toggle="modal" data-target="#details<?= $row['no_fos'] ?>" title="Detail"><?= $row['no_fos'] ?></a>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= site_url(ucfirst('maker/input/edit_input/'.$row['no_fos'])) ?>"><i class="fa fa-fw fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
