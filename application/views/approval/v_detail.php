<!-- Detail Log Error -->
<?php foreach ($getGagal->result() as $fail) { ?>
    <div class="modal fade" id="log<?= $fail->no_fos ?>" tabindex="-1" dialog="role" aria-labelledby="myModalLabel" arai-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Detail Log Error</h4>
                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" name="id_fasilitas" value="<?= $dt->id_fasilitas ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-5">
                                        <div class="datepicker-center">
                                            <div class="input-group date">
                                                <input type="text" name="tgl_cair" class="form-control" placeholder="yyyy-mm-dd" value="<?= $dt->tgl_cair == '0000-00-00' ? date('Y-m-d') : $dt->tgl_cair ?>">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <label>Tangga Jatuh Tempo</label>
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="modal-footer">
                        <button type="reset" class="btn btn-default">Reset <i class="glyphicon glyphicon-refresh"></i></button>
                        <button type="submit" class="btn btn-primary">Finish <i class="glyphicon glyphicon-check"></i></button>
                    </div>
                </div>
            </div>
        </div>
